...
<html lang="en">
        ...
        <div class="card">
          <div class="image-container">
            ...
            <div class="like-container">
              <button class="like-button" onclick="likeImage(1)">Like ❤️</button>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <div class="image-container">
            ...
            <div class="like-container">
              <button class="like-button" onclick="likeImage(2)">Like ❤️</button>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <div class="image-container">
            ...
            <div class="like-container">
              <button class="like-button" onclick="likeImage(3)">Like ❤️</button>
              <span id="likeCount3">0</span> Likes
            </div>
          </div>
          <div class="comment-section">
  ...
  <script>
    // Menyimpan jumlah like untuk setiap gambar
    let likeCounts = {1: 0, 2: 0, 3: 0};

    // Fungsi untuk menambah like
    function likeImage(imageId) {
        likeCounts[imageId]++;
        document.getElementById(`likeCount${imageId}`).textContent = likeCounts[imageId];
    }
    ...
    function addComment(imageId) {
        ...
        if (commentText) {
            const commentList = document.getElementById(`commentsList${imageId}`);
            const newComment = document.createElement('div');
            newComment.classList.add('comment');
            newComment.textContent = commentText;
            commentList.appendChild(newComment);
            commentInput.value = ''; // Mengosongkan input setelah komentar ditambahkan
        }
    }
  </script>
